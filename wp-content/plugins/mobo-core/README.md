...
![Plugin Version](https://img.shields.io/badge/Mobo_Core-10.31.62-1f6feb)
...
```php
// wp-config.php
// مقدار فعلی پیش فرض افزونه در نسخه 10.31.62:
...
```php
// wp-config.php
// Current built-in default in version 10.31.62:
define( 'MOBO_API_BASE_URL', 'http://mobo.codeya.ir/' );
```
